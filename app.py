...
class MyApp:
    def __init__(self, root:tk.Tk):
        ...
        # Generate Notebool for loaded data to appear
        self.noteList=ttk.Notebook(root)
        self.noteList.grid(row=0,column=0)
        ...
        self.FileMenu.add_command(label="Load folder",command=lambda:UI.Get_Folder(root,self.noteList))
